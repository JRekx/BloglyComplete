...
# Routes for managing tags and associating them with posts
@app.route('/tags')
def tags_index():
    tags = Tag.query.all()
...
def tags_show(tag_id):
    ...
    posts = Post.query.join(PostTag).filter(PostTag.tag_id == tag.id).all()
